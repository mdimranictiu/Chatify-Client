...
export default function chatLayout({ children }) {
  ...
  return (
    <div className="w-full px-2 rounded-sm min-h-screen">
      {/* Sidebar */}
      <aside className=" md:hidden w-full  rounded-sm text-black p-6 space-y-4">
        ...
        <div>
          ...
          <div>
            ...
            {/* Contacts recent */}
            <div
              className="overflow-y-auto h-84  flex flex-col gap-1 "
              style={{ scrollbarWidth: "none" }}
            >
              {/*  */}
